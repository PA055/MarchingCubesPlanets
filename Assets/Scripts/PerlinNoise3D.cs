...
public class PerlinNoise3D
{
    ...
    private static Vector3[] directions = new Vector3[16] {
    ...
    public static float Get3DPerlinNoise(Vector3 point)
    {
        ...
        Vector3 direction000 = directions[Permutations[permutationY00 + flooredPointZ0] & 15];
        Vector3 direction100 = directions[Permutations[permutationY10 + flooredPointZ0] & 15];
        Vector3 direction010 = directions[Permutations[permutationY01 + flooredPointZ0] & 15];
        Vector3 direction110 = directions[Permutations[permutationY11 + flooredPointZ0] & 15];
        Vector3 direction001 = directions[Permutations[permutationY00 + flooredPointZ1] & 15];
        Vector3 direction101 = directions[Permutations[permutationY10 + flooredPointZ1] & 15];
        Vector3 direction011 = directions[Permutations[permutationY01 + flooredPointZ1] & 15];
        Vector3 direction111 = directions[Permutations[permutationY11 + flooredPointZ1] & 15];
